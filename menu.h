...
public:
	void init() {
		...
		disablefakelagonkey2.setup(XOR("Fake-walk Dt"), XOR("disable fake-lag on key"));
		RegisterElement(&disablefakelagonkey2, 1);
...
public:
	void init() {
		...
		distortion_speed.AddShowCallback(callbacks::HasDistortion);
		...
		distortion_swap_amount.AddShowCallback(callbacks::HasDistortion);
		...
		body_fake_stand.setup(XOR("Lby"), XOR("body_fake_stnd"), { XOR("Off"), XOR("Left"), XOR("Right"), XOR("Opposite"), XOR("Z"), XOR("Macarena"), XOR("Break logic")});
		...
		body_fake_air.setup(XOR("Lby"), XOR("body_fake_air"), { XOR("Off"), XOR("Left"), XOR("Right"), XOR("Opposite"), XOR("180z")});
		...
		// col2.
		fake_yaw.setup(XOR("fake yaw"), XOR("fake_yaw"), { XOR("off"), XOR("default"), XOR("relative"), XOR("jitter"), XOR("rotate"), XOR("random"), XOR("local view"), XOR("opposite"), XOR("slow spin"), XOR("fast spin"), XOR("twist rotate")});
		...
		backward.setup(XOR("Forward"), XOR("backward"));
		backward.SetToggleCallback(callbacks::ToggleBack);
		RegisterElement(&backward, 1);

		fakeflick.setup(XOR("Fake flick"), XOR("fakeflick"));

		RegisterElement(&fakeflick, 1);
...
public:
	void init() {
		...
		indicators.setup(XOR("Indicators"), XOR("indicators"), { XOR("Lby"), XOR("Lag compensation"), XOR("Ping"), XOR("Doubletap"),  XOR("Fake-yaw"), XOR("Bomb")});
...
public:
	void init() {
		...
		config.setup(XOR("Cfg"), XOR("cfg"), { XOR("Auto"), XOR("Scout"), XOR("Awp"), XOR("Heavy pistol"), XOR("Pistol"), XOR("Nospread") });
		...
		autoaccept.setup(XOR("Clan-tag spammer"), XOR("autoaccept"));
		...
		aspect.setup(XOR("Aspect ratio"), XOR("aspect"), 0.1, 15, true, 0.1, 0.1, 0.1f);
		...
		HiddenCvar.setup(XOR("Unlock Cvars"));
		HiddenCvar.SetCallback(callbacks::HiddenCvar);
		RegisterElement(&HiddenCvar);

		ForceUpdate.setup(XOR("Force game update"));
